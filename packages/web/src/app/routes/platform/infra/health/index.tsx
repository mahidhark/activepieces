      ...
      message: (
        <span>
          {systemHealth?.disk
            ...
            : t(
                'Insufficient disk space. A minimum of 30GB is required for pip0 to function properly.',
              )}
        </span>
      ),
      loading: isPending,
    ...
    },
    {
      ...
      message: (
        <span>
          {systemHealth?.cpu
            ? t(
                'The server has enough CPU resources. At least 1 CPU core is required to run pip0.',
              )
            : t(
                'Not enough CPU resources. At least 1 CPU core is necessary to operate pip0.',
              )}
        </span>
      ),
      link: 'https://pip0.ai/docs/install/configuration/hardware#technical-specifications',
